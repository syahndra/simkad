                ...
                <div class="col-lg-12">
                    <div class="card-style mb-30" style="min-height: 650px; overflow: auto;">
                        ...
                        <form action="{{ route('ajuanCapil.update', $ajuan->idCapil) }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label>No KK</label>
                                <input type="text" name="noKK" class="form-control" value="{{ $ajuan->noKK }}" required>
                            </div>

                            <div class="mb-3">
                                <label>NIK</label>
                                <input type="text" name="nik" class="form-control" value="{{ $ajuan->nik }}" required>
                            </div>

                            <div class="mb-3">
                                <label>No Akta</label>
                                <input type="text" name="noAkta" class="form-control" value="{{ $ajuan->noAkta }}" required>
                            </div>

                            <div class="mb-3">
                                <label>Nama</label>
                                <input type="text" name="nama" class="form-control" value="{{ $ajuan->nama }}" required>
                            </div>
